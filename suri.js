...
btnblue.addEventListener("click",col1);
let col2 = () =>{
    for(var i =0;i<circlebtn.length;i++){
        circlebtn[i].style.background = "green";
    }
}
btngreen.addEventListener("click",col2);
let col3 = () =>{
    for(var i =0;i<circlebtn.length;i++){
        circlebtn[i].style.background = "white";
    }
}
btnwhite.addEventListener("click",col3);
let col4 = () =>{
    for(var i =0;i<circlebtn.length;i++){
        circlebtn[i].style.background = "red";
    }
}
btnred.addEventListener("click",col4);
